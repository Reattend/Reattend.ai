      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10 mb-14">
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2 mb-4"><Image src="/logo.png" alt="Rabbit" width={24} height={24} className="brightness-0 invert" /><span className="font-bold">Rabbit</span></div>
            <p className="text-sm text-neutral-400 leading-relaxed">AI research and products that put organizational memory at the core. Built by Reattend.</p>
          </div>
          <FCol title="Research" links={["Overview", "Training Log", "Benchmarks", "Data Ethics"]} />
          <FCol title="Product" links={["Model", "Signals", "Sandbox", "API Docs"]} />
          <FCol title="Enterprise" links={["Overview", "Deployment", "Compliance", "Contact Sales"]} />
          <FCol title="Company" links={["Reattend Platform", "Future of Work", "Contact"]} />
        </div>
        <div className="border-t border-neutral-800 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-neutral-500">
          ...
          <div className="flex gap-6"><a href="#" className="hover:text-white transition">Privacy</a><a href="#" className="hover:text-white transition">Terms</a></div>
        </div>
      </div>
    </footer>
  );
