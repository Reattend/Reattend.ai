    ...
    <main className="flex-1 bg-[#eee9f4]">
      ...
      <header className="px-6 py-5 flex items-center justify-between max-w-7xl mx-auto w-full">
        ...
        <div className="flex items-center gap-5 text-[13px]">
          <Link href="/login" className="text-[#6b5f7a] hover:text-[#1d1d1d] font-medium transition">API access</Link>
          <a href="https://reattend.ai" className="text-[#6b5f7a] hover:text-[#1d1d1d] font-medium transition">Reattend</a>
        </div>
      </header>
      ...
      <footer className="bg-[#1d1d1d] text-white px-6 py-16">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-10 mb-14">
            ...
            <FooterCol title="Research" links={["Overview", "Training Log", "Benchmarks", "Data Ethics"]} />
            <FooterCol title="Product" links={["Model", "Signals", "Sandbox", "API Docs"]} />
            <FooterCol title="Enterprise" links={["Overview", "Deployment", "Compliance", "Contact Sales"]} />
            <FooterCol title="Company" links={["Reattend Platform", "Future of Work", "Contact"]} />
          </div>
  ...
  return (
    <div>
      ...
      <ul className="space-y-2.5">
        {links.map((link) => (
          <li key={link}><a href="#" className="text-sm text-neutral-400 hover:text-white transition">{link}</a></li>
        ))}
      </ul>
    </div>
  );
